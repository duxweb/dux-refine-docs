...
var require_flexsearch_min = __commonJS({
  "node_modules/flexsearch/dist/flexsearch.min.js"(exports, module) {
    "use strict";
    (function(K, R, w) {
      let L;
      ...
      function V(a, c, b, d, e, f, h, g) {
        ...
        c[b] = e;
        e >= h && (a = a[g - (e + 0.5 >> 0)], a = a[b] || (a[b] = []), a[a.length] = d);
        return e;
      }
      function ba(a, c) {
        if (a) {
      ...
      function ca(a) {
        ...
        for (let e = 0; e < a.length; e++) {
          ...
          if (f !== b)
            if (e && "h" === f) {
              if (d = "a" === d || "e" === d || "i" === d || "o" === d || "u" === d || "y" === d, ("a" === b || "e" === b || "i" === b || "o" === b || "u" === b || "y" === b) && d || " " === b)
                c += f;
            } else
              c += f;
      ...
      function ha(a, c, b, d, e, f, h) {
        ...
        if (1 < p) {
          ...
          var u = true;
          let D, E = 0, N, da, X, ea;
          l && (2 === l.length ? (X = l, l = false) : l = ea = parseInt(l[0], 10));
          if (h) {
            for (v = B(); n < p; n++)
              if ("not" === e[n])
                for (x = a[n], I = x.length, m = 0; m < I; m++)
                  v["@" + x[m]] = 1;
              else
                da = n + 1;
            if (C(da))
      ...
      function sa() {
        ...
        self.onmessage = function(b) {
          if (b = b.data)
            if (b.search) {
              const d = c.search(b.content, b.threshold ? { limit: b.limit, threshold: b.threshold, where: b.where } : b.limit);
              self.postMessage({ id: a, content: b.content, limit: b.limit, result: d });
            } else
              b.add ? c.add(b.id, b.content) : b.update ? c.update(b.id, b.content) : b.remove ? c.remove(b.id) : b.clear ? c.clear() : b.info ? (b = c.info(), b.worker = a, console.log(b)) : b.register && (a = b.id, b.options.cache = false, b.options.async = false, b.options.worker = false, c = new Function(b.register.substring(b.register.indexOf("{") + 1, b.register.lastIndexOf("}")))(), c = new c(b.options));
        };
      }
      function ta(a, c, b, d) {
      ...
      const H = { encode: "icase", f: "forward", split: /\W+/, cache: false, async: false, g: false, D: false, a: false, b: 9, threshold: 0, depth: 0 }, ja = { memory: { encode: "extra", f: "strict", threshold: 0, b: 1 }, speed: { encode: "icase", f: "strict", threshold: 1, b: 3, depth: 2 }, match: {
        encode: "extra",
        f: "full",
        threshold: 1,
        b: 3
      }, score: { encode: "extra", f: "strict", threshold: 1, b: 9, depth: 4 }, balance: { encode: "balance", f: "strict", threshold: 0, b: 3, depth: 3 }, fast: { encode: "icase", f: "strict", threshold: 8, b: 9, depth: 1 } }, aa = [];
      let na = 0;
      const ka = {}, la = {};
      ...
      w.prototype.init = function(a, c) {
        ...
        this.w = (b = C(b = a.encode) ? c.encode || H.encode : b) && U[b] && U[b].bind(U) || (O(b) ? b : this.w || false);
        ...
        if (e) {
          ...
          if (d) {
            ...
            for (e = 0; e < d.length; e++)
              f = d[e], F(f) || (l && (a = l[f]), c[e] = f, d[e] = f.split(":")), g[f] = new w(a);
          }
          a.doc = b;
        }
        this.B = true;
        this.j = (this.cache = b = C(b = a.cache) ? this.cache || H.cache : b) ? new ua(b) : false;
        return this;
      };
      ...
      w.prototype.add = function(a, c, b, d, e) {
        ...
        if (c && J(c) && (a || 0 === a)) {
          ...
          if (!e) {
            ...
            if (b)
              return this.add(a, c, null, d, true), b(), this;
          }
          c = this.encode(c);
          if (!c.length)
            return this;
          ...
          const n = B();
          n._ctx = B();
          const m = e.length, u = this.threshold, q = this.depth, A = this.b, z = this.i, y = this.D;
          for (let t = 0; t < m; t++) {
            var h = e[t];
            if (h) {
              var g = h.length, k = (y ? t + 1 : m - t) / m, l = "";
              switch (b) {
                case "reverse":
                case "both":
                  for (var p = g; --p; )
                ...
                default:
                  if (g = V(z, n, h, a, 1, k, u, A - 1), q && 1 < m && g >= u)
                    for (g = n._ctx[h] || (n._ctx[h] = B()), h = this.h[h] || (this.h[h] = ia(A - (u || 0))), k = t - q, l = t + q + 1, 0 > k && (k = 0), l > m && (l = m); k < l; k++)
                      k !== t && V(h, g, e[k], a, 0, A - (k < t ? t - k : k - t), u, A - 1);
              }
            }
          }
          this.c[f] = 1;
      ...
      w.prototype.A = function(a, c, b) {
        if (F(c)) {
          ...
          var f = this.a.index, h = this.a.keys, g = this.a.tag;
          e = this.a.store;
          var k;
          var l = this.a.id;
          d = c;
      ...
      w.prototype.update = function(a, c, b) {
        if (this.a && G(a))
          return this.A("update", a, c);
        this.c["@" + a] && J(c) && (this.remove(a), this.add(a, c, b, true));
        return this;
      };
      w.prototype.remove = function(a, c, b) {
        ...
        if (this.c[d]) {
          if (this.g)
            return this.m[this.c[d]].postMessage({ remove: true, id: a }), delete this.c[d], c && c(), this;
          if (!b) {
            if (this.async && "function" !== typeof importScripts) {
              let e = this;
              d = new Promise(function(f) {
                setTimeout(function() {
                  e.remove(a, null, true);
                  e = null;
                  f();
                });
              });
      ...
      w.prototype.search = function(a, c, b, d) {
        if (G(c)) {
          ...
          c && O(c) ? (b = c, c = 1e3) : c || 0 === c || (c = 1e3);
        if (this.g) {
          this.F = b;
          this.u = 0;
          this.o = [];
          for (var f = 0; f < this.g; f++)
            this.m[f].postMessage({ search: true, limit: c, content: a });
        } else {
          var h = [], g = a;
          if (G(a) && !F(a)) {
          ...
          if (this.a) {
            ...
            if (m)
              ...
              for (var q = 0; q < g.length; q++)
                d = g[q], e = d.bool || n, m[q] = d.field, t[q] = e, "not" === e ? v = true : "and" === e && (x = true);
            } else
              m = this.a.keys;
            n = m.length;
            for (q = 0; q < n; q++)
            ...
            if (b)
              return b(P.call(this, a, t, h, k, c, p, y, l, x, v));
            if (this.async) {
              const I = this;
          ...
          if (!d) {
            ...
            if (b)
              return b(this.search(g, c, null, true)), this;
          }
          if (!a || !J(a))
            return h;
          g = a;
          ...
          e = [];
          var A = B(), z = 0;
          1 < u && (this.depth && "strict" === this.f ? n = true : b.sort(qa));
          if (!n || (q = this.h)) {
            const y = this.b;
            for (; z < u; z++) {
              let t = b[z];
      ...
      w.prototype.info = function() {
        if (this.g)
          for (let a = 0; a < this.g; a++)
            this.m[a].postMessage({ info: true, id: this.id });
        else
          return { id: this.id, items: this.length, cache: this.cache && this.cache.s ? this.cache.s.length : false, matcher: aa.length + (this.v ? this.v.length : 0), worker: this.g, threshold: this.threshold, depth: this.depth, resolution: this.b, contextual: this.depth && "strict" === this.f };
      };
      ...
      w.prototype.export = function(a) {
        ...
        if (this.a) {
          ...
          a = [this.i, this.h, Object.keys(this.c)];
        c && (a = JSON.stringify(a));
        return a;
      };
      w.prototype.import = function(a, c) {
        if (!c || C(c.serialize) || c.serialize)
          a = JSON.parse(a);
        const b = B();
        if (this.a) {
          var d = !c || C(c.doc) || c.doc, e = 0;
      ...
      const va = function() {
        const a = r("\\s+"), c = r("[^a-z0-9 ]"), b = [r("[-/]"), " ", c, "", a, " "];
        return function(d) {
        ...
        simple: function() {
          const a = r("\\s+"), c = r("[^a-z0-9 ]"), b = r("[-/]"), d = r("[\xE0\xE1\xE2\xE3\xE4\xE5]"), e = r("[\xE8\xE9\xEA\xEB]"), f = r("[\xEC\xED\xEE\xEF]"), h = r("[\xF2\xF3\xF4\xF5\xF6\u0151]"), g = r("[\xF9\xFA\xFB\xFC\u0171]"), k = r("[\xFD\u0177\xFF]"), l = r("\xF1"), p = r("[\xE7c]"), n = r("\xDF"), m = r(" & "), u = [d, "a", e, "e", f, "i", h, "o", g, "u", k, "y", l, "n", p, "k", n, "s", m, " and ", b, " ", c, "", a, " "];
          return function(q) {
            q = Q(q.toLowerCase(), u);
            return " " === q ? "" : q;
          };
        ...
        advanced: function() {
          const a = r("ae"), c = r("ai"), b = r("ay"), d = r("ey"), e = r("oe"), f = r("ue"), h = r("ie"), g = r("sz"), k = r("zs"), l = r("ck"), p = r("cc"), n = r("sh"), m = r("th"), u = r("dt"), q = r("ph"), A = r("pf"), z = r("ou"), y = r("uo"), t = [a, "a", c, "ei", b, "ei", d, "ei", e, "o", f, "u", h, "i", g, "s", k, "s", n, "s", l, "k", p, "k", m, "t", u, "t", q, "f", A, "f", z, "o", y, "u"];
          return function(v, x) {
            if (!v)
              return v;
            v = this.simple(v);
        ...
        extra: function() {
          const a = r("p"), c = r("z"), b = r("[cgq]"), d = r("n"), e = r("d"), f = r("[vw]"), h = r("[aeiouy]"), g = [a, "b", c, "s", b, "k", d, "m", e, "t", f, "f", h, ""];
          return function(k) {
            if (!k)
              return k;
            k = this.advanced(k, true);
            if (1 < k.length) {
              k = k.split(" ");
      ...
      const K = {}, R = "undefined" !== typeof Blob && "undefined" !== typeof URL && URL.createObjectURL;
      return function(w, L, S, W, P) {
        S = R ? URL.createObjectURL(new Blob(["(" + S.toString() + ")()"], { type: "text/javascript" })) : w + ".min.js";
        w += "-" + L;
        K[w] || (K[w] = []);
        K[w][P] = new Worker(S);
        K[w][P].onmessage = W;
...
// dep:flexsearch
var flexsearch_default = require_flexsearch_min();
export {
  flexsearch_default as default
};
